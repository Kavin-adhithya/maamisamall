...
function Component(){
    ...
    return(
        <div>
            <p onClick={handleLeftClick} style={{position:'relative',top:250}}><i class="bi bi-arrow-left-circle-fill"></i></p>
           
            <img src={list[index]}></img>

            <p onClick={handleRightClick} style={{position:'absolute',right:10,bottom:400}}> <i class="bi bi-arrow-right-circle-fill"></i></p>
        </div>
    )
}
